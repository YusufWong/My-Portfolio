...
### Background
 <img align="right"  src="https://github.com/YusufWong/My-Portfolio/blob/main/Projects/Chess-Game-App-Project/images/wiz_chess.gif" />
<p align="justify"> 
...
I initialized all the gridButtons on the board by coding the following: <br /> <br /> <br />
```java
